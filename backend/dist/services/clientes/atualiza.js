...
exports.atualiza_cadastro = void 0;
...
class atualiza_cadastro {
    ...
    async execute({ nome, nascimento, tipo, cpf, id, observacao, contatos, endereco }) {
        ...
        const [resultadoPesq] = await conexao_1.conexao.execute(queryPesq, [id]);
    ...
    async atualizarCliente(conn, clienteAtual, dadosCliente) {
    ...
    async atualizarEndereco(conn, clienteAtual, endereco, id) {
    ...
    async atualizarContatos(conn, clienteAtual, contatos, id) {
...
exports.atualiza_cadastro = atualiza_cadastro;
